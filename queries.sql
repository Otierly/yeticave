...
INSERT INTO `user` (`registration_date`, `email`, `login`, `password`, `avatar`, `contacts`) VALUES ('2022-05-15', 'bob@gmail.com', 'Bobik', 'O12345', 'avatar.jpg', '88005553535'),
                                                                                           ('2022-05-16', 'john@gmail.com', 'JJJohn', 'J12345', 'avatar.jpg', '88005553536');
/*Добавление в таблицу `lot`*/
INSERT INTO `lot` (`creation_date`, `name`, `description`, `img`, `start_price`, `end_date`, `price_step`, `id_author`, `id_winner`, `id_category`) VALUES ('2022-05-16', '2014 Rossignol District Snowboard', 'Легкий маневренный сноуборд, готовый дать жару в любом парке, растопив снег мощным щелчком и четкими дугами. Стекловолокно Bi-Ax, уложенное в двух направлениях, наделяет этот снаряд отличной гибкостью и отзывчивостью, а симметричная геометрия в сочетании с классическим прогибом кэмбер позволит уверенно держать высокие скорости. А если к концу катального дня сил совсем не останется, просто посмотрите на Вашу доску и улыбнитесь, крутая графика от Шона Кливера еще никого не оставляла равнодушным.', 'img/lot-1.jpg', '10999', '2022-05-17', '1', '1', '2', '1'),
...
INSERT INTO `bid` (`date`, `summ`, `id_user`, `id_lot`) VALUES ('2022-05-16', '12222','1','5'),
                                                                      ('2022-05-16', '132434','2','2'),
                                                                      ('2022-05-16', '5999','1','6'),
                                                                      ('2022-05-16', '14001','2','4'),
                                                                      ('2022-05-16', '22556','1','3'),
                                                                      ('2022-05-16', '14000','3','1');
...
UPDATE `lot` SET `name`= 'abcd' WHERE `id_lot` = 1;
