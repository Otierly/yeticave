...
?>
<?php
$array_categories = array('Доски и лыжи','Крепления','Ботинки','Одежда','Инструменты','Разное')
?>
<?php
$array_lots = [
    [
    'name'=>'2014 Rossignol District Snowboard',
    'categories'=>$array_categories[0],
    'price'=>'10999',
    'img'=>'img/lot-1.jpg'
    ],
